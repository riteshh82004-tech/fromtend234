  ...
  return (
    <section className="rounded-lg sm:rounded-xl border border-base-300 bg-base-100 p-4 sm:p-5 md:p-6">
      ...
      <div className="flex flex-col gap-3 sm:gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="text-base-content/70 text-xs sm:text-sm break-words">
          <p>
            Certificate{" "}
          ...
          {verifiedAt && <p className="mt-1">Verified on: {verifiedAt}</p>}
        </div>
      </div>
      {isVerified && (
        <p className="text-success mt-3 sm:mt-4 text-xs sm:text-sm font-medium">
