...
export function FeaturedProducts() {
  ...
  return (
    <AnimatedSection className="bg-base-100 py-16 md:py-24">
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="mt-14 text-center">
          <Link 
            to="/products" 
            className="btn btn-primary btn-wide font-bold rounded-xl shadow-lg shadow-primary/20 hover:shadow-primary/30 transition-all"
          >
