...
export function Contact() {
  ...
  return (
    <div className="bg-base-200/50 min-h-screen py-12 md:py-16">
        ...
        <div className="grid gap-10 lg:grid-cols-12 mb-12">
          ...
          <div className="lg:col-span-5 space-y-6">
            <AnimatedSection delayIndex={1}>
              <div className="card bg-base-100 border border-base-300 p-6 shadow-md rounded-2xl space-y-6">
                <div>
                ...
                <div className="grid grid-cols-2 gap-4 border-t border-base-300 pt-4 font-mono">
                  <div>
                ...
                <div className="border-t border-base-300 pt-4 space-y-3">
                  <div>
                    ...
                    <a
                      ...
                      className="text-lg font-black text-primary hover:underline font-mono"
                    >
                      +91 {company.phone}
                    </a>
                  </div>
                  <div>
                    ...
                    <a
                      ...
                      className="text-sm font-bold text-base-content hover:underline font-mono"
                    >
                ...
                <div className="bg-base-200 rounded-xl p-4 border border-base-300 text-xs text-base-content/70">
                  <p className="font-bold mb-1">Industrial Distribution Hours:</p>
                  <p>Mon – Sat: 9:00 AM – 7:00 PM IST</p>
                  <p className="text-[10px] text-base-content/40 mt-1">Closed on Sundays & National Holidays</p>
                </div>
              </div>
            </AnimatedSection>
          </div>
          ...
          <div className="lg:col-span-7">
            <AnimatedSection delayIndex={2}>
              <form onSubmit={handleSubmit} className="card bg-base-100 border border-base-300 shadow-md rounded-2xl">
                <div className="bg-primary/5 px-6 py-4 border-b border-base-300">
                  ...
                  <p className="text-xs text-base-content/60 mt-0.5">
                    Submit your request and our sales team will respond with a quote.
                  </p>
                </div>

                <div className="card-body p-6 gap-4">
                  {status === 'success' && (
                    <div className="alert alert-success animate-fade-in text-sm font-medium">
                      <span>✓ Thank you! Your quotation enquiry has been registered. Our representative will contact you shortly.</span>
                    </div>
                  )}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="form-control">
                      <label className="label py-1" htmlFor="name">
                        <span className="label-text text-xs font-bold uppercase tracking-wider text-base-content/60">Full Name *</span>
                      </label>
                      <input
                        id="name"
                        type="text"
                    ...
                    <div className="form-control">
                      <label className="label py-1" htmlFor="companyName">
                        <span className="label-text text-xs font-bold uppercase tracking-wider text-base-content/60">Company / Firm Name</span>
                      </label>
                      <input
                        id="companyName"
                        type="text"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="form-control">
                      <label className="label py-1" htmlFor="email">
                        <span className="label-text text-xs font-bold uppercase tracking-wider text-base-content/60">Email Address *</span>
                      </label>
                      <input
                        id="email"
                        type="email"
                    ...
                    <div className="form-control">
                      <label className="label py-1" htmlFor="phone">
                        <span className="label-text text-xs font-bold uppercase tracking-wider text-base-content/60">Contact Number *</span>
                      </label>
                      <input
                        id="phone"
                        type="tel"
                  ...
                  <div className="form-control">
                    <label className="label py-1" htmlFor="productInterest">
                      <span className="label-text text-xs font-bold uppercase tracking-wider text-base-content/60">Product of Interest *</span>
                    </label>
                    <select
                      id="productInterest"
                      className="select select-bordered select-sm rounded-lg w-full text-xs font-medium"
                    ...
                    >
                      ...
                      <option value="Switches & Sockets">Modular Switches & Accessories</option>
                      <option value="MCB & Distribution">MCB & Distribution Boxes</option>
                      <option value="Wires & Cables">Cables & Wires</option>
                      <option value="LED Lighting">LED Bulbs & Panel Lights</option>
                      <option value="Conduit & Junction Boxes">PVC Conduit Pipes & Junctions</option>
                      <option value="Coolers & Fans">Air Coolers & Ceiling Fans</option>
                      <option value="Dealership">Dealership / Distributorship Opportunity</option>
                    </select>
                  </div>

                  <div className="form-control">
                    <label className="label py-1" htmlFor="message">
                      <span className="label-text text-xs font-bold uppercase tracking-wider text-base-content/60">Detailed Requirements *</span>
                    </label>
                    <textarea
                      id="message"
                  ...
                  <button type="submit" className="btn btn-primary rounded-xl font-bold mt-2" disabled={loading}>
                    {loading ? (
                      <>
