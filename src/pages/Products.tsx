        ...
        <div className="mx-auto max-w-7xl px-4 text-center md:text-left flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div>
            ...
            <p className="text-neutral-content/75 text-sm md:text-base mt-2 max-w-2xl">
              Explore our dynamic catalogue of switches, MCBs, wires, cables, lighting, and accessories certified for peak safety and performance.
            </p>
          </div>
          <div className="bg-neutral-focus border border-neutral-content/20 p-4 rounded-xl shadow-inner shrink-0 text-center">
            <p className="text-xs text-neutral-content/60 font-semibold uppercase">Total Catalogued</p>
            <p className="text-3xl font-black text-primary mt-1">{PRODUCTS.length}+ Items</p>
          </div>
        </div>
      </div>
              ...
              <div className="card bg-base-100 border border-base-300 p-5 shadow-sm rounded-xl">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-xs font-bold leading-tight">ISO 9001:2000</p>
                      <p className="text-[10px] text-base-content/50">Certified Standards</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-xs font-bold leading-tight">MILAN POWER</p>
                      <p className="text-[10px] text-base-content/50">Official Distributor</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <main className="flex-grow space-y-6">
            ...
            <div className="card bg-base-100 border border-base-300 p-4 shadow-sm rounded-xl flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div className="text-xs text-base-content/60 font-medium md:text-right shrink-0">
                Showing <span className="font-bold text-base-content">{filteredProducts.length}</span> of{' '}
                <span className="font-bold text-base-content">{PRODUCTS.length}</span> products
              </div>
            </div>
